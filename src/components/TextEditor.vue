<template>
  ...
  >
    ...
    <div class="toolbar f-row">
      ...
      >
        <v-tooltip slot="tooltip" align="c;tt">Bold (Ctrl+B)</v-tooltip>
      ...
      >
        <v-tooltip slot="tooltip" align="c;tt">Italic (Ctrl+I)</v-tooltip>
      ...
      >
        <v-tooltip slot="tooltip" align="c;tt">Underline (Ctrl+U)</v-tooltip>
      ...
      >
        <v-tooltip slot="tooltip" align="c;tt">Strike (Ctrl+Shift+7)</v-tooltip>
        <v-icon name="format_strikethrough"/>
      </v-btn>
      <v-menu align="ll;tb,bt" @closed="toggleLink" @opened="$refs.hyperlink.focus()">
        <template v-slot:activator="{ toggle }">
          ...
          >
            <v-tooltip slot="tooltip" align="c;tt">Hyperlink</v-tooltip>
      ...
      >
        <v-tooltip slot="tooltip" align="c;tt">Unordered list (Ctrl+Shift+8)</v-tooltip>
      ...
      >
        <v-tooltip slot="tooltip" align="c;tt">Ordered list (Ctrl+Shift+9)</v-tooltip>
      ...
      >
        <template v-slot:activator="{ toggle }">
          <v-btn
            ...
            @click="toggle"
          >
            <v-tooltip slot="tooltip" align="c;tt">Text size</v-tooltip>
      ...
      >
        <template v-slot:activator="{ toggle }">
          <v-btn
            ...
            @click="toggle"
          >
            <v-tooltip slot="tooltip" align="c;tt">Text color</v-tooltip>
      ...
      <v-btn
        ...
        @click="align('left')"
      >
        <v-tooltip slot="tooltip" align="c;tt">Align left</v-tooltip>
      ...
      <v-btn
        ...
        @click="align('center')"
      >
        <v-tooltip slot="tooltip" align="c;tt">Align center</v-tooltip>
      ...
      <v-btn
        ...
        @click="align('right')"
      >
        <v-tooltip slot="tooltip" align="c;tt">Align right</v-tooltip>
      ...
      <v-btn
        ...
        @click="undo"
      >
        <v-tooltip slot="tooltip" align="c;tt">Undo (Ctrl+Z)</v-tooltip>
        <v-icon name="undo"/>
      </v-btn>
      <v-btn
        aria-label="Redo"
        ...
        @click="redo"
      >
        <v-tooltip slot="tooltip" align="c;tt">Redo (Ctrl+Y)</v-tooltip>
        <v-icon name="redo"/>
      </v-btn>
      <div class="separator"/>
      <v-menu align="ll;tb,bt" :items="menuItems">
        <template v-slot:activator="{ toggle }">
          <v-btn
            aria-label="Menu"
            class="icon small"
            ...
            @click="toggle"
          >
            <v-tooltip slot="tooltip" align="c;tt">Menu</v-tooltip>
...
export default {
  components: { ColorPicker, InputField },
  mixins: [ Focusable ],
  props: {
    body: String,
    autofocus: Boolean,
